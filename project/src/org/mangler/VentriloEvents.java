...
public class VentriloEvents 
{
	...
	public static final int V3_EVENT_CHANGE_CHANNEL 		= 21;
	public static final int V3_EVENT_PHANTOM_ADD 			= 22;
	public static final int V3_EVENT_PHANTOM_REMOVE 		= 23;

	public static final int V3_EVENT_USER_PAGED 			= 24;
	public static final int V3_EVENT_LUSER_FORCE_CHAN_MOVE 	= 25;
    public static final int V3_EVENT_CHAN_REMOVED 			= 26;
    public static final int V3_EVENT_CHAN_MODIFIED 			= 27;
    public static final int V3_EVENT_RECV_AUDIO				= 28;
}