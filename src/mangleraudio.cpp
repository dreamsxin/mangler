...
ManglerAudio::ManglerAudio(uint16_t userid, uint32_t rate) {
    ...
    this->userid = userid;
    if (!(pulse_stream = pa_simple_new(NULL, "mangler", PA_STREAM_PLAYBACK, "alsa_output.usb_device_46d_a01_noserial_if0_sound_card_0_alsa_playback_0", "playback", &pulse_samplespec, NULL, NULL, &error))) {
